...
proc create_root_design { parentCell } {
  ...
  set data [ create_bd_port -dir IO -type data data ]
  set led [ create_bd_port -dir O -from 3 -to 0 -type data led ]
  set rst [ create_bd_port -dir I -type rst rst ]
  set sw [ create_bd_port -dir I -from 3 -to 0 -type data sw ]

  # Create instance: dht11_sa_top, and set properties
  set dht11_sa_top [ create_bd_cell -type ip -vlnv www.telecom-paristech.fr:DHT11_SA_TOP:dht11_sa_top:1.0 dht11_sa_top ]
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_net -net Net [get_bd_ports data] [get_bd_pins dht11_sa_top/data]
  connect_bd_net -net btn_1 [get_bd_ports btn] [get_bd_pins dht11_sa_top/btn]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins dht11_sa_top/clk]
  connect_bd_net -net dht11_sa_top_led [get_bd_ports led] [get_bd_pins dht11_sa_top/led]
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins dht11_sa_top/rst]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins dht11_sa_top/sw]
