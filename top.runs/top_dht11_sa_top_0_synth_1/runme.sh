...
HD_PWD='/homes/palmiero/Desktop/DHT11_Controller/top.runs/top_dht11_sa_top_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dht11_sa_top_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_dht11_sa_top_0.tcl
